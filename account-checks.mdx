...
If security is your main concern, it is often best to access Sysvar data directly from the sysvar syscalls instead of passing in an account, as this closes off all Sysvar-account-based attack vectors.
