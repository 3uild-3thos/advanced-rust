...
A brief list of checks you should perform would consist of:
...
5. Mint Checks
6. PDA Checks
7. Close Account Checks

There are many other things you will likely need to consider to secure your program, but these are the most common footguns you will come up against.
