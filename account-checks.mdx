...
Relying on syscalls also allow us to send less data to the chain, as we just have to reference the syscall in our program, instead of passing in the account.
