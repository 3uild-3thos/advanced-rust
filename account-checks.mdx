...
Account checks are one of the most important important things we must consider to secure our Solana programs. Here is a list of common account checks you should consider performing, along with _how_ and _why_.
