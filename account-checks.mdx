...
When dealing with the concept of permissions in our programs, we typically rely upon cryptogrpahic proofs of identity. While Soalana supports several cryptographic signature schemes, such as  
